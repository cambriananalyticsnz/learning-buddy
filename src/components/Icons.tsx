...
export function AtomIcon({ className, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="3" />
      <path d="M19.9 4.1a10 10 0 0 0-15.8 0" />
      <path d="M4.1 19.9a10 10 0 0 0 15.8 0" />
      <path d="M2.1 12a10 10 0 0 0 19.8 0" />
    </svg>
  );
}
...
export function DnaIcon({ className, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M8 2a10 10 0 0 1 8 0" />
      <path d="M8 22a10 10 0 0 0 8 0" />
      <path d="M6 6a10 10 0 0 0 12 0" />
      <path d="M6 18a10 10 0 0 1 12 0" />
      <path d="M12 12v.01" />
    </svg>
  );
}
...
export function CoinIcon({ className, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="12" r="10" />
      <path d="M14.5 9a2.5 2.5 0 0 0-5 0c0 1.4 2 2.5 2.5 3 0 0 2.5 1 2.5 2.5a2.5 2.5 0 0 1-5 0" />
    </svg>
  );
}
...
export function FireIcon({ className, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 22c4 0 6-3 6-7 0-4-3-7-6-10C9 8 6 11 6 15c0 4 2 7 6 7Z" />
      <path d="M12 22c-1.5 0-3-1-3-3 0-2 1.5-3 3-3s3 1 3 3c0 2-1.5 3-3 3Z" />
    </svg>
  );
}
...
export function SparkleIcon({ className, size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M18 13c.3 1.5 1.5 2.7 3 3-1.5.3-2.7 1.5-3 3-.3-1.5-1.5-2.7-3-3 1.5-.3 2.7-1.5 3-3Z" />
    </svg>
  );
}
...
export function SubjectIcon({ subject, className, size = 16 }: { subject: string; className?: string; size?: number }) {
  switch (subject) {
    case "Chemistry":
      return <AtomIcon className={className} size={size} />;
    case "Biology":
      return <DnaIcon className={className} size={size} />;
    case "Math":
      return <FunctionIcon className={className} size={size} />;
    case "Computer Science":
      return <MonitorIcon className={className} size={size} />;
    default:
      return <MonitorIcon className={className} size={size} />;
  }
}
